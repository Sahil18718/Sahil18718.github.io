    ...
    <section id="projects" className="projects section">
      ...
      {projects.map((project, index) => (
        <div className="project-card" data-aos="fade-up" key={index}>
          {/* Image Section */}
          <div className="project-card_img_section" data-aos="fade-right">
            <div
          ...
          {/* Description Section */}
          <div className="project-card_description_section" data-aos="fade-left">
            ...
            <div className="project_btn">
              ...
              <a href={project.live} className="project-deployed-link" target="_blank" rel="noopener noreferrer">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  role="img"
                  viewBox="0 0 24 24"
