...
const HomeSection = () => {
  return (
    <section
      id="home"
      className="min-h-screen flex items-center justify-center pt-16 md:pt-20 px-4 sm:px-6 bg-gray-50 dark:bg-black"
    >
      <div className="max-w-4xl mx-auto w-full">
        <div className="space-y-6 md:space-y-8 text-center sm:text-left">
          ...
          <div className="space-y-2 md:space-y-3">
            <p className="text-pink-600 dark:text-pink-400 text-lg sm:text-xl font-medium">Hi, my name is</p>
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-gray-900 dark:text-white tracking-tight leading-tight">
              SAHIL MALVIYA
            </h1>
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-gray-600 dark:text-gray-300 leading-tight">
              Software Engineer
            </h2>
          </div>

          <p className="text-base sm:text-lg text-gray-600 dark:text-gray-400 max-w-2xl leading-relaxed mx-auto sm:mx-0">
