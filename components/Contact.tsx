...
const Contact = () => {
  return (
    <section id="contact" className="py-12 sm:py-16 md:py-24 px-4 sm:px-6 bg-gray-50 dark:bg-black">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 sm:gap-6 md:gap-8 mb-6 sm:mb-8 md:mb-12">
          {contactMethods.map((method, index) => (
            <a
              ...
              className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-4 sm:p-6 hover:shadow-lg dark:hover:shadow-2xl dark:hover:shadow-pink-500/10 transition-all duration-200 group"
            >
              <div className="flex items-start">
                <div className="bg-pink-100 dark:bg-pink-900/50 text-pink-600 dark:text-pink-400 p-2 sm:p-3 rounded-lg mr-3 sm:mr-4 group-hover:bg-pink-200 dark:group-hover:bg-pink-900/70 transition-colors duration-200">
                  {method.icon}
                </div>
        ...
        <div className="text-center">
          <a
            ...
            className="inline-flex items-center bg-pink-600 hover:bg-pink-700 dark:bg-pink-500 dark:hover:bg-pink-600 text-white px-4 sm:px-6 md:px-8 py-2.5 sm:py-3 md:py-4 rounded-lg font-medium transition-colors duration-200 group w-full sm:w-auto justify-center shadow-sm text-sm sm:text-base"
          >
