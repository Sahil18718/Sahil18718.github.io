...
const About = () => {
  return (
    <section id="about" className="py-12 sm:py-16 md:py-24 px-4 sm:px-6 bg-white dark:bg-gray-900">
          ...
          <div className="space-y-6 order-2 lg:order-1">
            ...
            <div className="pt-4">
              <a
                ...
                className="inline-flex items-center bg-pink-600 hover:bg-pink-700 dark:bg-pink-500 dark:hover:bg-pink-600 text-white px-4 sm:px-6 py-2.5 sm:py-3 rounded-lg font-medium transition-colors duration-200 group w-full sm:w-auto justify-center sm:justify-start shadow-sm text-sm sm:text-base"
              >
