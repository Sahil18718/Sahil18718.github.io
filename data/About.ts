export const aboutData = {
  ...
  intro: {
    hiddenSkills: [
      "React Native", "React JS", "NodeJS", "JavaScript", "MongoDB", "Frontend", "Backend", "Python", "SQL", "UI", "HTML", "CSS", "Express", "RESTful APIs"
    ],
    introduction:
    ...
    details: "For more details on my skills and projects, please see the sections below.",
  },
  resume: {
